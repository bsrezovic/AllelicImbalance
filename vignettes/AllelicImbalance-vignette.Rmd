...
In addition to the location, stored informationn could for example be genotype,
...
barplot(a.simple[1], type="fraction", sampleColour.top=sampleColour.top,
...
the AllelicImbalance package has now functions that can be integrated in the grid
...
than the gbarplot. Base graphics also produce graphs faster than the grid environment. The advantage of the gbarplot
